...
SECRET_KEY = 'e#z85!@#xe82l2v7!lc$@!a4%^&jx96hflzimed^i%#3)ig&wj'
...
host_for_db = 'localhost' if DEBUG else 'db'
DATABASES = {
        'default': {
...
REDIS_PORT = '6379'
RABBIT_MQ_PORT = '5672'
CELERY_BROKER_URL = 'amqp://guest:guest@' + RABBIT_MQ_HOST + ':' + RABBIT_MQ_PORT + '//'
